...
#****************************
export RUN_DIR=/home/alorta/.local/runtime
export INSTALL_DIR=/home/alorta/.local/install
export TMP_DIR=/home/alorta/.local/tmp
...
export CLUSTER_TOOLS_VERSION=pystache
